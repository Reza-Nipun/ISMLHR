...
$SQL_STR1 = "SELECT ei.Unit, ei.Department as dp, ei.[Staff Category] as sc, COUNT(py.EmployeeCode) AS sum from DayWisePayHour py, EmployeePIMSinfo ei WHERE ei.EmployeeCode=py.EmployeeCode AND ei.BuN='ISML' AND ei.EmployeeStatus='Active' AND py.WorkDate='2014-10-30' AND py.ARADayStatus like 'LV' GROUP BY ei.Unit,ei.Department,ei.[Staff Category] ORDER BY ei.Unit,ei.[Staff Category]";
