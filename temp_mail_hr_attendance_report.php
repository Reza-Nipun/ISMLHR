...
$SQL="SELECT COUNT(DISTINCT EmployeeCode) AS sum, [Staff Category] as sc FROM EmployeePIMSinfo WHERE EmployeeStatus='Active' AND Unit='UNIT-09' GROUP BY [Staff Category]";
...
$SQL="SELECT COUNT(DISTINCT EmployeeCode) AS sum, [Staff Category] as sc FROM EmployeePIMSinfo WHERE EmployeeStatus='Active' AND Unit='UNIT-09-U2' GROUP BY [Staff Category]";
...
$SQL="SELECT COUNT(DayWisePayHour.EmployeeCode) AS sum, EmployeePIMSinfo.[Staff Category] as sc from DayWisePayHour INNER JOIN EmployeePIMSinfo ON EmployeePIMSinfo.EmployeeCode=DayWisePayHour.EmployeeCode WHERE EmployeePIMSinfo.Unit='UNIT-09' AND EmployeePIMSinfo.EmployeeStatus='Active' AND DayWisePayHour.WorkDate='$today' AND DayWisePayHour.ARADayStatus='LV' GROUP BY EmployeePIMSinfo.[Staff Category]";
		//die($SQL);
		$result = mssql_query($SQL);
...
$SQL="SELECT COUNT(DayWisePayHour.EmployeeCode) AS sum, EmployeePIMSinfo.[Staff Category] as sc from DayWisePayHour INNER JOIN EmployeePIMSinfo ON EmployeePIMSinfo.EmployeeCode=DayWisePayHour.EmployeeCode WHERE EmployeePIMSinfo.Unit='UNIT-09-U2' AND EmployeePIMSinfo.EmployeeStatus='Active' AND DayWisePayHour.WorkDate='$today' AND DayWisePayHour.ARADayStatus='LV' GROUP BY EmployeePIMSinfo.[Staff Category]";
		//die($SQL);
		$result = mssql_query($SQL);
            ...
            <table width="65%" cellpadding="0" cellspacing="0">
               <tr>
                  <td style="background-color:#025C64; color:#FFF; padding: 14px 0px 14px 12px">
                     <span style="font-size: 38px;">ISML Daily Attendance Summary</span>
                  </td>
