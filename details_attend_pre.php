...
$SQL_STR1 = "SELECT ei.Unit, ei.Department as dp, ei.[Staff Category] as sc, COUNT(DISTINCT vt.EmployeeCode) AS sum from vewDeviceRowData_U_RowDataBack vt, EmployeePIMSinfo ei WHERE ei.EmployeeCode=vt.EmployeeCode AND ei.BuN='ISML' AND ei.EmployeeStatus='Active' AND vt.WorkDate='$today' GROUP BY ei.Unit,ei.Department,ei.[Staff Category] ORDER BY ei.Unit,ei.[Staff Category]";
