...
//$today = '2014-09-27';
        ...
        $SQL_STR1 = "SELECT COUNT(DISTINCT EmployeeCode) AS sum, [Staff Category] as sc FROM EmployeePIMSinfo WHERE EmployeeStatus like 'Active' AND Unit like 'UNIT-09' GROUP BY [Staff Category]";
        ...
        $SQL_STR2 = "SELECT COUNT(DISTINCT EmployeeCode) AS sum, [Staff Category] as sc FROM EmployeePIMSinfo WHERE EmployeeStatus like 'Active' AND Unit like 'UNIT-09-U2' GROUP BY [Staff Category]";
...
//	LV MLV Start ****************
		$SQL_LV1 = "SELECT COUNT(DayWisePayHour.EmployeeCode) AS sum, EmployeePIMSinfo.[Staff Category] as sc from DayWisePayHour INNER JOIN EmployeePIMSinfo ON EmployeePIMSinfo.EmployeeCode=DayWisePayHour.EmployeeCode WHERE EmployeePIMSinfo.Unit like 'UNIT-09' AND EmployeePIMSinfo.EmployeeStatus like 'Active' AND DayWisePayHour.WorkDate like '$today' AND DayWisePayHour.ARADayStatus like 'LV' GROUP BY EmployeePIMSinfo.[Staff Category]";
echo $SQL;
die($SQL);
...
/// MLV
		$SQL_LV2 = "SELECT COUNT(DayWisePayHour.EmployeeCode) AS sum, EmployeePIMSinfo.[Staff Category] as sc from DayWisePayHour INNER JOIN EmployeePIMSinfo ON EmployeePIMSinfo.EmployeeCode=DayWisePayHour.EmployeeCode WHERE EmployeePIMSinfo.Unit like 'UNIT-09-U2' AND EmployeePIMSinfo.EmployeeStatus like 'Active' AND DayWisePayHour.WorkDate like '$today' AND DayWisePayHour.ARADayStatus like 'LV' GROUP BY EmployeePIMSinfo.[Staff Category]";
        //die($SQL);
...
/// MLV
		$SQL_MLV2 = "SELECT COUNT(DISTINCT MaternityLeaveTrans.EmployeeCode) as sum, EmployeePIMSinfo.[Staff Category] as sc FROM MaternityLeaveTrans INNER JOIN EmployeePIMSinfo ON EmployeePIMSinfo.EmployeeCode=MaternityLeaveTrans.EmployeeCode where EmployeePIMSinfo.Unit like 'UNIT-09-U2' AND CONVERT(VARCHAR(10),ToDate,21)>='$today' GROUP BY EmployeePIMSinfo.[Staff Category]";
//        die($SQL_MLV1);
