...
$date=$date->format("m/d/Y");
    ...
    $newdate_1 = strtotime( '-10 day' , strtotime( $date ) ) ;
    $previous_date_1 = date ( 'm/d/Y' , $newdate_1 );
...
//	LV MLV Start ****************
		$SQL_LV1 = "SELECT COUNT(DayWisePayHour.EmployeeCode) AS sum, EmployeePIMSinfo.[Staff Category] as sc 
from DayWisePayHour INNER JOIN EmployeePIMSinfo ON EmployeePIMSinfo.EmployeeCode=DayWisePayHour.EmployeeCode 
WHERE EmployeePIMSinfo.Unit='UNIT-09' AND EmployeePIMSinfo.EmployeeStatus='Active' 
AND DayWisePayHour.WorkDate='$today' AND DayWisePayHour.ARADayStatus like 'LV' GROUP BY EmployeePIMSinfo.[Staff Category]";
        //die($SQL);
...
// Contineuous Absent Start

	$SQL_CA3 = "Select E.Employeecode,e.PunchCardNo,E.EmployeeName,E.Designationdes as Designation,Department,E.Bun,E.Unit,
				E.Floor,E.DOJ,E.[Staff category],E.[Line Infodes],E.[Team Info],D.DayStatus,
				Count(D.Employeecode) as TA From Employeepimsinfo E 
				inner join Daywisepayhour D on E.Employeecode=D.Employeecode 

				where Workdate between '$previous_date_1' and '$date' and Daystatus='A' 
				and E.Unit in ('UNIT-09', 'UNIT-09-U2', 'UNIT-09-U3') and E.EmployeeStatus='ACTIVE'
				group by E.Employeecode,E.EmployeeName,E.Designationdes,E.Floor,E.DOJ,E.[Line Infodes],E.[Team Info], 
				D.DayStatus,E.Unit,Department,E.Bun,e.PunchCardNo,E.[Staff category] Having Count (D.Employeecode)>=7";
        $result_ca3 = mssql_query($SQL_CA3);

        $total_contineuous_abs = 0;

        while ($row_ca = mssql_fetch_array($result_ca3)) {
            $total_contineuous_abs++;
        }


    if ($total_contineuous_abs != 0){
        $total_contineuous_abs_percentage = round(($total_contineuous_abs / $strength_total) * 100, 2) . " %";}

// Contineuous Absent End 

// Contineuous Absent Start - ISML01

    $SQL_CA3_01 = "Select E.Employeecode,e.PunchCardNo,E.EmployeeName,E.Designationdes as Designation,Department,E.Bun,E.Unit,
				E.Floor,E.DOJ,E.[Staff category] as stf_cat,E.[Line Infodes],E.[Team Info],D.DayStatus,
				Count(D.Employeecode) as TA From Employeepimsinfo E 
				inner join Daywisepayhour D on E.Employeecode=D.Employeecode 

				where Workdate between '$previous_date_1' and '$date' and Daystatus='A' 
				and E.Unit in ('UNIT-09') and E.EmployeeStatus='ACTIVE'
				group by E.Employeecode,E.EmployeeName,E.Designationdes,E.Floor,E.DOJ,E.[Line Infodes],E.[Team Info], 
				D.DayStatus,E.Unit,Department,E.Bun,e.PunchCardNo,E.[Staff category] Having Count (D.Employeecode)>=7";
    $result_ca3_01 = mssql_query($SQL_CA3_01);

    $isml01_total_con_abs = 0;
    $isml01_FW_con_abs = 0;
    $isml01_NMS_con_abs = 0;
    $isml01_MS_con_abs = 0;

    while ($row_ca_01 = mssql_fetch_array($result_ca3_01)) {
        $ISMLU1_staff_cat = $row_ca_01['stf_cat'];

        if($ISMLU1_staff_cat == 'FW'){
            $isml01_FW_con_abs++;
            $isml01_total_con_abs++;
        }


        if($ISMLU1_staff_cat == 'NMS'){
            $isml01_NMS_con_abs++;
            $isml01_total_con_abs++;
        }

        if($ISMLU1_staff_cat == 'MS'){
            $isml01_MS_con_abs++;
            $isml01_total_con_abs++;
        }
...
// Contineuous Absent End - ISML01

// Contineuous Absent Start - ISML02

    $SQL_CA3_02 = "Select E.Employeecode,e.PunchCardNo,E.EmployeeName,E.Designationdes as Designation,Department,E.Bun,E.Unit,
				E.Floor,E.DOJ,E.[Staff category],E.[Line Infodes],E.[Team Info],D.DayStatus,
				Count(D.Employeecode) as TA From Employeepimsinfo E 
				inner join Daywisepayhour D on E.Employeecode=D.Employeecode 

				where Workdate between '$previous_date_1' and '$date' and Daystatus='A' 
				and E.Unit in ('UNIT-09-U2') and E.EmployeeStatus='ACTIVE'
				group by E.Employeecode,E.EmployeeName,E.Designationdes,E.Floor,E.DOJ,E.[Line Infodes],E.[Team Info], 
				D.DayStatus,E.Unit,Department,E.Bun,e.PunchCardNo,E.[Staff category] Having Count (D.Employeecode)>=7";
    $result_ca3_02 = mssql_query($SQL_CA3_02);

    $isml02_total_con_abs = 0;
    $isml02_FW_con_abs = 0;
    $isml02_NMS_con_abs = 0;
    $isml02_MS_con_abs = 0;

    while ($row_ca_02 = mssql_fetch_array($result_ca3_02)) {
        $ISMLU2_staff_cat = $row_ca_02['stf_cat'];

        if($ISMLU2_staff_cat == 'FW'){
            $isml02_FW_con_abs++;
            $isml02_total_con_abs++;
        }


        if($ISMLU2_staff_cat == 'NMS'){
            $isml02_NMS_con_abs++;
            $isml02_total_con_abs++;
        }

        if($ISMLU2_staff_cat == 'MS'){
            $isml02_MS_con_abs++;
            $isml02_total_con_abs++;
        }
...
// Contineuous Absent End - ISML02

// Contineuous Absent Start - EcoFab

    $SQL_CA3_03 = "Select E.Employeecode,e.PunchCardNo,E.EmployeeName,E.Designationdes as Designation,Department,E.Bun,E.Unit,
				E.Floor,E.DOJ,E.[Staff category],E.[Line Infodes],E.[Team Info],D.DayStatus,
				Count(D.Employeecode) as TA From Employeepimsinfo E 
				inner join Daywisepayhour D on E.Employeecode=D.Employeecode 

				where Workdate between '$previous_date_1' and '$date' and Daystatus='A' 
				and E.Unit in ('UNIT-09-U3') and E.EmployeeStatus='ACTIVE'
				group by E.Employeecode,E.EmployeeName,E.Designationdes,E.Floor,E.DOJ,E.[Line Infodes],E.[Team Info], 
				D.DayStatus,E.Unit,Department,E.Bun,e.PunchCardNo,E.[Staff category] Having Count (D.Employeecode)>=7";
    $result_ca3_03 = mssql_query($SQL_CA3_03);


    $ecofab_total_con_abs = 0;
    $ecofab_FW_con_abs = 0;
    $ecofab_NMS_con_abs = 0;
    $ecofab_MS_con_abs = 0;

    while ($row_ca_03 = mssql_fetch_array($result_ca3_03)) {
        $ecofab_staff_cat = $row_ca_03['stf_cat'];

        if($ecofab_staff_cat == 'FW'){
            $ecofab_FW_con_abs++;
            $ecofab_total_con_abs++;
        }

        if($ecofab_staff_cat == 'NMS'){
            $ecofab_NMS_con_abs++;
            $ecofab_total_con_abs++;
        }

        if($ecofab_staff_cat == 'MS'){
            $ecofab_MS_con_abs++;
            $ecofab_total_con_abs++;
        }
    }

// Contineuous Absent End - EcoFab
	...
	// End of Unit-09-U3 attnd percentage Calculation
        ...
        $total_regular_abs = $absent_total - $total_contineuous_abs;
        if ($total_regular_abs != 0){
            $total_regular_abs_percentage = round(($total_regular_abs / $strength_total) * 100, 2) . " %";}

    $total_normal_abs_isml01 = ($absent_NMS1-$isml01_NMS_con_abs)+($absent_MS1-$isml01_MS_con_abs)+($absent_FW1-$isml01_FW_con_abs);
    $total_normal_abs_isml02 = ($absent_NMS2-$isml02_NMS_con_abs)+($absent_MS2-$isml02_MS_con_abs)+($absent_FW2-$isml02_FW_con_abs);
    $total_normal_abs_ecofab = ($absent_NMS3-$ecofab_NMS_con_abs)+($absent_MS3-$ecofab_MS_con_abs)+($absent_FW3-$ecofab_FW_con_abs);
...
if ($present_total == 0)
	{ 
		$toemail= array('nipun.sarker@interfabshirt.com');
		//$cc_mail_list = array('nipun.sarker@interfabshirt.com');
		//$bcc_mail_list = array('mahbubur.rahman@viyellatexgroup.com');
	}
	...
	{ 
		...
		$toemail= array('nipun.sarker@interfabshirt.com');
		/*$cc_mail_list = array('shohal.bhuiyan@viyellatexgroup.com', 'nipun.sarker@viyellatexgroup.com');
		$bcc_mail_list = array('shohal.bhuiyan@viyellatexgroup.com');*/
		...
		//$cc_mail_list = array('amir.hasanat@viyellatexgroup.com', 'ali.hossain@interfabshirt.com', 'nesar.ahmed@interfabshirt.com', 'chandana.perera@interfabshirt.com', 'arif.abdulla@interfabshirt.com', 'aleya.aktar@interfabshirt.com', 'masud.uddin@interfabshirt.com', 'tanay.saha@interfabshirt.com', 'mesbah.haque@interfabshirt.com', 'nazrul.chowdhury@interfabshirt.com');
		
		//$bcc_mail_list = array('masum.ikbal@viyellatexgroup.com', 'liza.amena@viyellatexgroup.com', 'nipun.sarker@viyellatexgroup.com');
                    ...
                    <tr>
                        <td valign="top" style="font-family: Arial, Verdana, sans-serif; padding-left: 5px; line-height: 10px; color:#222222" >
                            ...
                            <table align="center" border="1" width="40%" cellspacing="0" cellpadding="0" class="bottomBorder" style="line-height: 20px">
								...
								<tr style="font-size:14px">
                                    <th scope="row">Con. Absent</th>
                                    <th scope="row">'.$total_contineuous_abs_percentage.'</th>
                                </tr>
                                <tr style="font-size:14px">
                                    <th scope="row">Normal Absent</th>
                                    <th scope="row">'.$total_regular_abs_percentage.'</th>
                                </tr>
                                <tr style="font-size:14px">
                            ...
                            <table align="center" border="1" width="90%" cellspacing="0" cellpadding="0" class="bottomBorder" style="line-height: 20px">
                                <tr style="font-size:14px" bgcolor="#FFBC00">
                                    ...
                                    <th width="16%" scope="row">Con. Absent</th>
                                    <th width="16%" scope="row">Normal Absent</th>
                                ...
                                <tr align="center" style="font-size:14px">
                                    ...
                                    <th >'.$isml01_FW_con_abs.'</th>
                                    <th >'.($absent_FW1-$isml01_FW_con_abs).'</th>
                                    <th >'.$absent_FW1.'</th>
                                ...
                                <tr style="font-size:14px">
                                    ...
                                    <th scope="row">'.$isml01_NMS_con_abs.'</th>
                                    <th scope="row">'.($absent_NMS1-$isml01_NMS_con_abs).'</th>
                                ...
                                <tr style="font-size:14px">
                                    ...
                                    <th scope="row">'.$isml01_MS_con_abs.'</th>
                                    <th scope="row">'.($absent_MS1-$isml01_MS_con_abs).'</th>
                                ...
                                <tr style="font-size:14px">
                                    ...
                                    <th scope="row">'.$isml01_total_con_abs.'</th>
                                    <th scope="row">'.$total_normal_abs_isml01.'</th>
                                    <th scope="row">'.$absent_unit1.'</th>
                                    <th scope="row" align="right">'.$LV_unit1.'&nbsp;<a href="http://10.234.20.55/ismlhr/leave_details.php?UID=UNIT-09" title="Leave Details">(Details)</a></th>
                                </tr>
                            </table>
                            ...
                            <table align="center" border="1" width="90%" cellspacing="0" cellpadding="0" class="bottomBorder" style="line-height: 20px">
                                ...
                                <tr align="center" style="font-size:14px">
                                    ...
                                    <th >'.$isml02_FW_con_abs.'</th>
                                    <th >'.($absent_FW2-$isml02_FW_con_abs).'</th>
                                    <th >'.$absent_FW2.'</th>
                                ...
                                <tr style="font-size:14px">
                                    ...
                                    <th scope="row">'.$isml02_NMS_con_abs.'</th>
                                    <th scope="row">'.($absent_NMS2-$isml02_NMS_con_abs).'</th>
                                ...
                                <tr style="font-size:14px">
                                    ...
                                    <th scope="row">'.$isml02_MS_con_abs.'</th>
                                    <th scope="row">'.($absent_MS2-$isml02_MS_con_abs).'</th>
                                ...
                                <tr style="font-size:14px">
                                    ...
                                    <th scope="row">'.$isml02_total_con_abs.'</th>
                                    <th scope="row">'.$total_normal_abs_isml02.'</th>
                                    <th scope="row">'.$absent_unit2.'</th>
                                    <th scope="row" align="right">'.$LV_unit2.'&nbsp;<a href="http://10.234.20.55/ismlhr/leave_details.php?UID=UNIT-09-U2" title="Leave Details">(Details)</a></th>
                                </tr>
                            </table>
                            ...
                            <table align="center" border="1" width="90%" cellspacing="0" cellpadding="0" class="bottomBorder" style="line-height: 20px">
                                ...
                                <tr align="center" style="font-size:14px">
                                    ...
                                    <th >'.$ecofab_FW_con_abs.'</th>
                                    <th >'.($absent_FW3-$ecofab_FW_con_abs).'</th>
                                    <th >'.$absent_FW3.'</th>
                                ...
                                <tr style="font-size:14px">
                                    ...
                                    <th scope="row">'.$ecofab_NMS_con_abs.'</th>
                                    <th scope="row">'.($absent_NMS3-$ecofab_NMS_con_abs).'</th>
                                ...
                                <tr style="font-size:14px">
                                    ...
                                    <th scope="row">'.$ecofab_MS_con_abs.'</th>
                                    <th scope="row">'.($absent_MS3-$ecofab_MS_con_abs).'</th>
                                ...
                                <tr style="font-size:14px">
                                    ...
                                    <th scope="row">'.$ecofab_total_con_abs.'</th>
                                    <th scope="row">'.$total_normal_abs_ecofab.'</th>
                                    <th scope="row">'.$absent_unit3.'</th>
                                    <th scope="row" align="right">'.$LV_unit3.'&nbsp;<a href="http://10.234.20.55/ismlhr/leave_details.php?UID=UNIT-09-U3" title="Leave Details">(Details)</a></th>
                                </tr>
                            </table>
