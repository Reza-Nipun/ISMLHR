...
//if($mail_status) exit("Auto Mail already sent for Today at $time_id, Date: $date_id");
		...
		$fromname = 'HR_ManualMail: ISML Daily Attendance Summary';
...
///////////////////	For REAL Manual Mail	\\\\\\\\\\\\\\\\\\\\


if ($present_total == 0)
	{ 
		$toemail= array('masum.ikbal@viyellatexgroup.com');
		$cc_mail_list = array('masud.uddin@interfabshirt.com');
		$bcc_mail_list = array('shohal.bhuiyan@interfabshirt.com');
	}
...
$cc_mail_list = array('arif.abdulla@interfabshirt.com', 'aleya.aktar@interfabshirt.com', 'khandakar.rafiq@viyellatexgroup.com', 'masum.ikbal@viyellatexgroup.com','shohal.bhuiyan@interfabshirt.com');
                ...
                <table width="65%" cellpadding="0" cellspacing="0">
                   <tr>
                     <td style="background-color:#025C64; color:#FFF; padding: 14px 0px 14px 12px">
                         <span style="font-size: 28px;"><strong>ISML Daily Attendance Summary</strong>  (<span class="test_run">To Check</span>)</span>
             </td>
