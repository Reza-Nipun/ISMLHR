...
<p align="center" class="unit"> <strong>Unit-1</strong>+2</p>
  <table class="style44" border="1" align="center" title="AQL All Data">
    <tr>
      <th width="355">Unit</th>
      <th width="355">Department</th>
      <th width="245">Staff Category</th>
...
$selected = mssql_select_db($db_name, $dbhandle)or die("Cannot select DB");    
        ...
        $SQL_STR1 = "SELECT Unit, Department as dp, [Staff Category] as sc, COUNT(DISTINCT EmployeeCode) AS sum FROM EmployeePIMSinfo WHERE EmployeeStatus='Active' AND BuN='ISML' GROUP BY Unit,Department,[Staff Category] ORDER BY Unit,[Staff Category]";
