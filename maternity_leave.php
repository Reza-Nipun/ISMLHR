...
<form action="maternity_leave.php" method="post">
            ...
            if(isset($unit)){
                ...
                while($row_dt = mssql_fetch_array($result_dt)){
                    ...
                    $SQL_MLV = "SELECT EmployeePIMSinfo.* 
                                ...
                                AND CONVERT(VARCHAR(10),ToDate,21)>='$work_date'";

                    $result_mlv = mssql_query($SQL_MLV);

                    $count_mlv_emp=0;

                    while($row_mlv = mssql_fetch_array($result_mlv)){
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a target="_blank" href="maternity_leave_report_detail.php?emp_type=<?php echo $emp_type;?>&unit=<?php echo $unit;?>&date=<?php echo $work_date;?>">
                                <?php echo $count_mlv_emp;?>
                            </a>
                        </td>
                    </tr>
